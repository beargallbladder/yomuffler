...
```bash
# Development
python3 start_production.py          # Start full production stack
python3 start_render.py             # Start Render-optimized version
python3 scripts/demo.py             # Run 4-VIN demo
python3 scripts/optimize_production.py  # System health optimization

# Data Integration
python3 scripts/nhtsa_integration.py    # NHTSA complaint validation
python3 scripts/noaa_weather_integration.py  # Weather data integration
python3 scripts/generate_lead_database.py   # Enterprise lead generation

# Testing
python3 scripts/weather_validation_system.py  # Government data validation
```

## Critical Files
- `src/engines/bayesian_engine_v2.py` - Core mathematical calculations
- `src/swarm/master_orchestrator.py` - Swarm coordination
- `src/services/integration_manager.py` - Data source management
- `src/api/gateway.py` - FastAPI endpoints

## Development Guidelines
- **Academic Accuracy**: All mathematical formulas must match Argonne research
- **Government Data**: Validate against NOAA/NHTSA official sources
- **Production Ready**: Health score must be ≥75/100
- **Authentication**: HTTP Basic Auth (dealer:stressors2024)
- **Revenue Focus**: Track financial impact of risk predictions

## Current Challenges
- System health optimization (currently 75/100)
- Desktop UI responsiveness improvements
- Integration of additional government data sources
- Performance optimization for 10K+ VIN processing

## Success Metrics
- Mathematical accuracy validation
- Government data integration reliability
- Production deployment health
- Revenue opportunity identification ($1M+ pipeline)
